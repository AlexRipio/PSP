...
public class SocketCliente {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("CLIENTE: Introduzca los numeros a operar, y el código de operación");
			...
			String numero3 = sc.nextLine(); // Codigo de operación (Suma/Resta/Producto/Division)
